...
class RequiredSpreadTest
{
    ...
    void test3()
    {
        DMContext dmContext = new DMContext(Criteria.constructCriteria("C", 2, false), null, new Alternatives(new ArrayList<>()), null, false, 0);
        RequiredSpread rs = new RequiredSpread(1.0d);
        TerminationResult TR = null;
        String msg = null;
        try
        {
            TR = rs.shouldTerminate(dmContext);
        } catch (RefinerException e)
        {
            msg = e.getMessage();
        }
        assertNull(msg);
        assertNotNull(TR);
        assertFalse(TR._shouldTerminate);
        assertEquals("Alternatives set is empty (empty set is assumed to be valid)", TR._message);
    }
    ...
    void test5()
    {
        ...
        assertEquals("The thresholds are not provided (the array is null)", msg);
    }
    ...
    void test6()
    {
        ...
        assertEquals("The thresholds are not provided (the array is empty)", msg);
    }
    ...
    void test7()
    {
        ArrayList<Alternative> A = new ArrayList<>();
        A.add(new Alternative("A1", new double[2]));
        DMContext dmContext = new DMContext(Criteria.constructCriteria("C", 3, false), null, new Alternatives(A), null, false, 0);
        ...
        assertEquals("The number of criteria (3) differs from the number of thresholds (2) (and the number of thresholds is not 1)", msg);
    }
    ...
    void test8()
    {
        ...
        assertEquals("The alternative A1 does not have enough evaluations (required at least 2 but has 1)", msg);
    }
    ...
    void test9()
    {
        ...
        assertNotNull(TR);
        assertFalse(TR._shouldTerminate);
        assertEquals("Threshold exceeded or equal at criteria = C0 C1", TR._message);
    }
    ...
    void test11()
    {
        ...
        assertNull(msg);
        assertNotNull(TR);
        assertTrue(TR._shouldTerminate);
        assertEquals("The set is invalid (not sufficiently spread)", TR._message);
    }
    ...
    void test12()
    {
        ...
        assertNotNull(TR);
        assertFalse(TR._shouldTerminate);
        assertEquals("Threshold exceeded or equal at criterion = C1", TR._message);
    }
    ...
    void test13()
    {
        ...
        assertEquals("Not enough normalization objects were constructed (1 but at least 2 are required)", msg);
    }
