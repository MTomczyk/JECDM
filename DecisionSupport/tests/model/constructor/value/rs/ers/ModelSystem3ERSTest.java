...
class ModelSystem3ERSTest
{
    ...
    void test1()
    {
        ...
        assertEquals(0.0d, report._report._successRateInPreserving, 1.0E-1);
        assertEquals(0, report._report._modelsPreservedBetweenIterations, 1.0E-1);
        ...
        assertEquals(1.0d / 2.0d, (double) report._report._rejectedNewlyConstructedModels / report._report._acceptedNewlyConstructedModels, 1.0E-1);
        ...
        assertTrue(toSample <= (double) report._report._acceptedNewlyConstructedModels);
        assertEquals(0.5d, (double) report._report._acceptedNewlyConstructedModels / report._report._rejectedNewlyConstructedModels, 1.0E-1);
...

        {
            ...
            assertTrue(toSample <= m._acceptedNewlyConstructedModels);
...

        {
            ...
            assertEquals(0.5d, (double) m._modelsPreservedBetweenIterations / toSample, 1.0E-1);
            assertEquals(0.0d, (double) m._modelsRejectedBetweenIterations / toSample, 1.0E-1);

            assertEquals(1.0d / 3.0d, m._successRateInConstructing, 1.0E-1);
            assertTrue(toSample <= (double) m._acceptedNewlyConstructedModels);
