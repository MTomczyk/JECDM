 ...
 * Also, it is assumed that the decision vectors are double vectors created by an implementation of the auxiliary {@link IConstruct} interface.
 *
 * @author MTomczyk
 */
final public class DoubleConstruct extends AbstractConstruct implements IConstruct
{
    /**
     * Supportive interface for delivering (constructing) initial decision vectors (doubles).
     */
     ...
     */
    public DoubleConstruct(IConstruct constructor)
    {
