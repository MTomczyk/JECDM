 ...
 * Also, it is assumed that the decision vectors are int vectors created by an implementation of the auxiliary {@link IConstruct} interface.
 *
 * @author MTomczyk
 */
final public class IntConstruct extends AbstractConstruct implements IConstruct
{
    /**
     ...
     */
    public IntConstruct(IConstruct constructor)
    {
