...
/**
 * Implementation of the WFG7 test problem (easy = minimal number of decision variables and no transformations).
 *
 * @author MTomczyk
 */


public class WFG7Easy extends WFG7
{
    /**
