...
public class WFG4_3D_Cumulative
{
    /**
     * Runs the script.
     *
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor3D("MOAE/D", new MarkerStyle(0.02f, Gradient.getViridisGradient(), 3, Marker.SPHERE_LOW_POLY_3D));
