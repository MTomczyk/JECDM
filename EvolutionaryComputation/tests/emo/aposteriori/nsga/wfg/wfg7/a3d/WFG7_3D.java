package emo.aposteriori.nsga.wfg.wfg7.a3d;
...
import emo.aposteriori.nsga.wfg.wfg7.a2d.WFG7_2D_Cumulative_DisplayAtTheEnd;
...
public class WFG7_3D
{
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor3D("NSGA-II", new MarkerStyle(0.02f, color.gradient.Color.RED, Marker.SPHERE_LOW_POLY_3D));
