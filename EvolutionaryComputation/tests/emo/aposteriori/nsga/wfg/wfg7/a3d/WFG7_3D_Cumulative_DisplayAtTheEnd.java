...
public class WFG7_3D_Cumulative_DisplayAtTheEnd
{
    /**
     * Runs the script.
     *
    ...
    {
        (new WFG7_3D_Cumulative_DisplayAtTheEnd()).test1();
    }
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor3D("NSGA", new MarkerStyle(0.02f, Gradient.getViridisGradient(), 3, Marker.SPHERE_LOW_POLY_3D));
