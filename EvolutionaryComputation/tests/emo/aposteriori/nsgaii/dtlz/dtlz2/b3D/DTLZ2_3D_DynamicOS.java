package emo.aposteriori.nsgaii.dtlz.dtlz2.b3D;
...
/**
 * Solving DTLZ problem (3D) using NSGA-II.
 * The visualization module is run to present the results.
 *
 * @author MTomczyk
 */

public class DTLZ2_3D_DynamicOS
{
    /**
     * Runs the script.
     *
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor3D("NSGA-II", new MarkerStyle(0.02f, Color.RED, Marker.SPHERE_LOW_POLY_3D));
