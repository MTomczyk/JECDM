package emo.aposteriori.nsgaiii.dtlz.dtlz5.a2D;
...
import emo.aposteriori.nsgaiii.dtlz.dtlz4.b3D.DTLZ4_3D_Cumulative_DisplayAtTheEnd;
...
public class DTLZ5_2D
{
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor2D("NSGA-III", new MarkerStyle(2.0f, color.gradient.Color.RED, Marker.CIRCLE));
