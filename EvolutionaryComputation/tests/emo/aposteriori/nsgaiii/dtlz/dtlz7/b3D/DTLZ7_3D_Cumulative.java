package emo.aposteriori.nsgaiii.dtlz.dtlz7.b3D;
...
public class DTLZ7_3D_Cumulative
{
    /**
     * Runs the script.
     *
    ...
    public void test1()
    {
        ...
        IGoal[] goals = GoalsFactory.getPointLineProjectionsDND(3, 20, problemBundle._normalizations);
