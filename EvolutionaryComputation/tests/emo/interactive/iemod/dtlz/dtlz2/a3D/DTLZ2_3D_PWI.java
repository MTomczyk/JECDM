package emo.interactive.iemod.dtlz.dtlz2.a3D;
...
public class DTLZ2_3D_PWI
{
    ...
    public void test1()
    {
        ...
        IPreferenceModel<model.internals.value.scalarizing.LNorm> PM = new LNorm();
        IReferenceSetConstructor RSC = new PWI(PM);

        EA iemod = Utils.getIEMOD(criteria, problemBundle, dynamicObjectiveRanges, R, goals,
                new Euclidean(), new IterationInterval(200, 100), RSC,
                Utils.getDefaultDMFeedbackProvider3D(problemBundle._normalizations), PM,
