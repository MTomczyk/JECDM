package emo.interactive.ktscone.dcemo.wfg.wfg3.a2D;
...
import ea.EA;
import emo.Utils;
import emo.interactive.ktscone.dcemo.wfg.wfg2.a3D.WFG2_3D_Cumulative_DisplayAtTheEnd;
...
/**
 * Solving DTLZ problem (2D) using DCEMO.
 * The visualization module is run to present the results.
 *
 * @author MTomczyk
 */

public class WFG3_2D
{
    /**
     * Runs the script.
     *
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor2D("DCEMO", new MarkerStyle(2.0f, color.gradient.Color.RED, Marker.CIRCLE));
        IVisualization visualization = Utils.getVisualization(frame, dcemo, ds, false);
