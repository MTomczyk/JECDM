package emo.interactive.ktscone.dcemo.wfg.wfg4.a2D;
...
public class WFG4_2D_Cumulative_DisplayAtTheEnd
{
    /**
     * Runs the script.
     *
    ...
    {
        (new WFG4_2D_Cumulative_DisplayAtTheEnd()).test1();
    }
    ...
    public void test1()
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor2D("DCEMO", new MarkerStyle(2.0f, Gradient.getViridisGradient(), 2, Marker.CIRCLE));
