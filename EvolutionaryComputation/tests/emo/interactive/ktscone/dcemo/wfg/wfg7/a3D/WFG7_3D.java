package emo.interactive.ktscone.dcemo.wfg.wfg7.a3D;
...
public class WFG7_3D
{
    ...
    public static void main(String[] args)
    {
        ...
        // create updater
        DataSet ds = DataSet.getFor3D("DCEMO", new MarkerStyle(0.02f, color.gradient.Color.RED, Marker.SPHERE_LOW_POLY_3D));
