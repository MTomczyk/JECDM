...
/**
 * Various tests for the GD performance indicator {@link GD}.
 *
 * @author MTomczyk
 */
class GDTest
{
    ...
    void evaluate2()
    {
        ...
        GD gd = new GD(distance, rp);
        double performance = gd.evaluate(specimens);
        assertEquals(5.0d / 4.0d, performance, 0.000001d);
    }
    ...
    void evaluate3()
    {
        ...
        GD gd = new GD(distance, rp);
        double performance = gd.evaluate(specimens);
        assertEquals((1.0d + 1.0d + Math.sqrt(2.0d) + 2.0d * Math.sqrt(2.0d)) / 4.0d, performance, 0.000001d);
    }
}