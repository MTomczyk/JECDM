...
/**
 * Provides various tests for {@link OnSimplexSimplexMutation}
 *
 * @author MTomczyk
 */
class OnSimplexSimplexMutationTest3D
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        IMutate mutate = new OnSimplexSimplexMutation(0.5d);

        double[] p = new double[]{0.25d, 0.25d, 0.5d};
        ...
        pP._heatmapDisplayRange.setNormalizer(new Gamma(1.0f));
