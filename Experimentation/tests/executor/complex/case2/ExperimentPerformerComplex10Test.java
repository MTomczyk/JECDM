 ...
 * @author MTomczyk
 */
class ExperimentPerformerComplex10Test
{
    ...
    void test()
    {
        ...
        try
        {
            folderPath = FileUtils.getPathRelatedToClass(ExperimentPerformerComplex10Test.class,
                ...
                for (int sheet = 0; sheet < 3; sheet++)
                {
                    ...
                    for (int row = 0; row < 2; row++)
                    {
                        ...
                        for (int column = 0; column < 6; column++)
                        {
                            ...
                            if (ExpectedResults._expectedFinalResults6_10[sheet][row][column] == null)
                                assertSame(cell.getCellType(), CellType.BLANK);
                            else
                            {
                                assertEquals(ExpectedResults._expectedFinalResults6_10[sheet][row][column],
