 ...
 * @author MTomczyk
 */
class ExperimentPerformerComplex14Test
{
    ...
    void test()
    {
        ...
        pGDC._referenceCrossSavers.add(new FinalRankerXLS("PS", new ITest[]{null, null}, 2));
        pGDC._referenceCrossSavers.add(new FinalRankerXLSX("PS", new ITest[]{null, null}, 2));


        String folderPath = "";
        String msg = null;
        try {
            folderPath = FileUtils.getPathRelatedToClass(ExperimentPerformerComplex14Test.class,
