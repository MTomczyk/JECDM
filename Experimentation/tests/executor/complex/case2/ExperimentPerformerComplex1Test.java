...
class ExperimentPerformerComplex1Test
{
    ...
    void test()
    {
      ...
      //  pGDC._referenceScenarioSavers.add(new ExcelSaverHSSF());
        ...
        assertEquals("java.io.FileNotFoundException", s.getScenariosSummaries()[0].getExceptionMessage()[2].substring(10, 39));
        assertFalse(s.getScenariosSummaries()[0].isSkipped());
        ...
        assertEquals("java.io.FileNotFoundException", s.getScenariosSummaries()[3].getExceptionMessage()[2].substring(10, 39));
        assertFalse(s.getScenariosSummaries()[3].isSkipped());
