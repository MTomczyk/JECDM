 ...
 * @author MTomczyk
 */
class ExperimentPerformerComplex9Test
{
    ...
    void test()
    {
        ...
        pGDC._referenceScenarioSavers.add(new SummarizerXLS(style));
        pGDC._referenceScenarioSavers.add(new SummarizerXLSX(style));
        ...
        try
        {
            folderPath = FileUtils.getPathRelatedToClass(ExperimentPerformerComplex9Test.class,
                ...
                for (int sheet = 0; sheet < 3; sheet++)
                {
                    ...
                    for (int row = 0; row < 2; row++)
                    {
                        ...
                        for (int column = 0; column < 6; column++)
                        {
                            ...
                            if (ExpectedResults._expectedFinalResults9[sheet][row][column] == null)
                                assertSame(cell.getCellType(), CellType.BLANK);
                            else
                            {
                                assertEquals(ExpectedResults._expectedFinalResults9[sheet][row][column],
