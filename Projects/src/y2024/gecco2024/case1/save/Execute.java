package y2024.gecco2024.case1.save;
...
/**
 * Executes processing for Case #1.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #1 heatmap (NSGA-II; 2D; generation; min; avg)"; // experiment title
        String fileName = "nsgaii_2d_generation_min_average"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case1/save/"; // prefix for paths for files to be generated (case folder)
