package y2024.gecco2024.case11.save;
...
/**
 * Executes processing for Case #11.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #11 heatmap (MOEA/D; 2D; 1; min; sum, alpha=1)"; // experiment title
        String fileName = "moead_2d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case11/save/"; // prefix for paths for files to be generated (case folder)
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            IGoal [] G = GoalsFactory.getLNormsDND(2, populationSize - 1, 1.0d);
