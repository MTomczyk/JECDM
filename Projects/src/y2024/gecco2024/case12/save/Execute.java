package y2024.gecco2024.case12.save;
...
/**
 * Executes processing for Case #12.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #12 heatmap (MOEA/D; 2D; 1; min; sum, alpha=2.5)"; // experiment title
        String fileName = "moead_2d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case12/save/"; // prefix for paths for files to be generated (case folder)
        ...
        Range hatmapDisplayRange = new Range(0.0d, trials); // set the heatmap normalization bounds to (0, generations); generations is here the maximum possible bucket value
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            IGoal [] G = GoalsFactory.getLNormsDND( 2, populationSize - 1, 2.5d);
        ...
        PP[0]._heatmapDisplayRange = hatmapDisplayRange; // set the heatmap normalization bounds to (0, generations); generations is here the maximum possible bucket value
