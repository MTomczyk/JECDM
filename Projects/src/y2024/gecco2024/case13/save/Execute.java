package y2024.gecco2024.case13.save;
...
/**
 * Executes processing for Case #13.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #13 heatmap (MOEA/D; 2D; 1; min; sum, alpha=5)"; // experiment title
        String fileName = "moead_2d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case13/save/"; // prefix for paths for files to be generated (case folder)
        ...
        Range displayRangeBounds = new Range(0.0d, trials); // set the heatmap normalization bounds to (0, generations); generations is here the maximum possible bucket value
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            IGoal[] G = GoalsFactory.getLNormsDND(2, populationSize - 1, 5.0d);
        ...
        PP[0]._heatmapDisplayRange = displayRangeBounds; // set the heatmap normalization bounds to (0, generations); generations is here the maximum possible bucket value
