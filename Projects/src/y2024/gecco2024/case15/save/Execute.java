package y2024.gecco2024.case15.save;
...
/**
 * Executes processing for Case #15.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #15 heatmap (NSGA-II; 2D; 1; min; sum)"; // experiment title
        String fileName = "nsgaii_2d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case15/save/"; // prefix for paths for files to be generated (case folder)
        ...
        int generations = 401; // no. generations (stopping criterion); not 200, because 0th generation (construction of the initial population) also accounts
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            // only "next value" functions can be called; the number of decision variables is set to 5
