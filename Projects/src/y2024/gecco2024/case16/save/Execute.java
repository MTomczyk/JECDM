package y2024.gecco2024.case16.save;
...
/**
 * Executes processing for Case #16.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #16 heatmap (NSGA-II; 3D; generation; min; avg)"; // experiment title
        String fileName = "nsgaii_3d_generation_min_average"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case16/save/"; // prefix for paths for files to be generated (case folder)
        ...
        String zAxisTitle = "f3"; // title to be displayed on the y-axis

        int trials = 200; // number of test runs
        int dimensions = 3; // number of dimensions
        int populationSize = 90; // population size
        int offspringSize = 90; // offspring size
        int generations = 401; // no. generations (stopping criterion); not 300, because 0th generation (construction of the initial population) also accounts
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            Problem problem = Problem.DTLZ1; // Problem ID selection: DTLZ1
            ...
            // only "next value" functions can be called; the number of decision variables is set to 10
            DTLZBundle problemBundle = DTLZBundle.getBundle(problem, dimensions, 5);
