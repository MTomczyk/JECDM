package y2024.gecco2024.case17.save;
...
/**
 * Executes processing for Case #17.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #17 heatmap (NSGA-II; 3D; 1; min; sum)"; // experiment title
        String fileName = "nsgaii_3d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case17/save/"; // prefix for paths for files to be generated (case folder)
