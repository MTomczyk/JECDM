...
/**
 * Executes processing for Case #19.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #19 heatmap (NSGA-II; 2D; 1; min; sum)"; // experiment title
        String fileName = "nsgaii_2d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case19/save/"; // prefix for paths for files to be generated (case folder)
        ...
        int generations = 501; // no. generations (stopping criterion); not 200, because 0th generation (construction of the initial population) also accounts
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            int shift = 2;
            double bias = 10.0d;
            DTLZBundle referenceBundle = DTLZBundle.getBundle(problem, 2, 20 + shift); // fake to introduce new 3 position related attribute
            // Let's add biased distribution
            DTLZBundle problemBundle = new DTLZBundle(problem, referenceBundle._construct, referenceBundle._reproduce,
                    new DTLZ2_BiasedDistribution(2, 20 + shift, bias, shift), referenceBundle._displayRanges,
                    referenceBundle._paretoFrontBounds, referenceBundle._normalizations,
                    referenceBundle._utopia, referenceBundle._nadir,
                    referenceBundle._optimizationDirections, referenceBundle._criteria);
            ...
            PhasesBundle.copyPhasesFromBundleToEA(pEA, algorithmBundle._phasesBundle); // copy and paste EA phases from the NSGA-II bundle to the general EA instance
