package y2024.gecco2024.case2.save;
...
/**
 * Executes processing for Case #2.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #2 heatmap (NSGA-II; 3D; generation; min; avg)"; // experiment title
        String fileName = "nsgaii_3d_generation_min_average"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case2/save/"; // prefix for paths for files to be generated (case folder)
