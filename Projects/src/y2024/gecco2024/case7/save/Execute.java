package y2024.gecco2024.case7.save;
...
/**
 * Executes processing for Case #7.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #7 heatmap (NSGA-II; 2D; 1; min; sum)"; // experiment title
        String fileName = "nsgaii_2d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case7/save/"; // prefix for paths for files to be generated (case folder)
