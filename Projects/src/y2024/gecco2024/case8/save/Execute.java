package y2024.gecco2024.case8.save;
...
/**
 * Executes processing for Case #8.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #8 heatmap (MOEA/D; 2D; generation; min; avg)"; // experiment title
        String fileName = "moead_3d_generation_min_average"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case8/save/"; // prefix for paths for files to be generated (case folder)
        ...
        int generations = 301; // no. generations (stopping criterion); not 100, because 0th generation (construction of the initial population) also accounts
        ...
        int zAxisDivisions = 100; // no. of divisions on the y-axis (discretization level, determines the total. no buckets for the heatmap)
        ...
        Range zDisplayRange = new Range(0.0d, 2.0d); // display range for the y-axis (subspace to be discretized)
        ...
        pHP._finalStatistics = new Max(); // determine the final-bucket statistic as the average of the collected minima
        ...
        pHP._eaFactory = () -> { // Factory object construct new instance of an EA.
            ...
            IGoal[] G = GoalsFactory.getLNormsDND( 3, 10, Double.POSITIVE_INFINITY);
