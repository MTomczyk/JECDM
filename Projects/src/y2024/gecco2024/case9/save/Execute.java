package y2024.gecco2024.case9.save;
...
/**
 * Executes processing for Case #9.
 *
 * @author MTomczyk
 */
...
public class Execute
{
    ...
    public static void main(String[] args)
    {
        ...
        String frameTitle = "Case #9 heatmap (MOEA/D; 2D; 1; min; sum)"; // experiment title
        String fileName = "moead_3d_1_min_sum"; // file name (without extension) for files to be generated
        String pathPrefix = "./Projects/src/y2024/gecco2024/case9/save/"; // prefix for paths for files to be generated (case folder)
