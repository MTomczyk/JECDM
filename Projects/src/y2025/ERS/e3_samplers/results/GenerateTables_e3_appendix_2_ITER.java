...
public class GenerateTables_e3_appendix_2_ITER
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            path = FileUtils.getPathRelatedToClass(GenerateTables_e3_appendix_2_ITER.class, "Projects", "src", File.separatorChar);
