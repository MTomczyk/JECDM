...
public class GenerateTables_e3_appendix_4_NCM
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            path = FileUtils.getPathRelatedToClass(GenerateTables_e3_appendix_4_NCM.class, "Projects", "src", File.separatorChar);
            ...
            p._decimalPrecisionForNumericalInColumns = new int[]{0, 0, 0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
                    2, 2, 2, 2, 2, 2, 2};
