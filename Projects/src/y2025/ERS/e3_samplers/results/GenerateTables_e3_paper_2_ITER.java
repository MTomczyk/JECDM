...
public class GenerateTables_e3_paper_2_ITER
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            path = FileUtils.getPathRelatedToClass(GenerateTables_e3_paper_2_ITER.class, "Projects", "src", File.separatorChar);
            String xlsxPath = path + File.separator + "e3_samplers_2_IterWhenFound.xlsx";
            ...
            p._decimalPrecisionForNumericalInColumns = new int[]{0, 0, 0, 0, 3, 3, 3, 3, 3, 3, 3, 3, 3};
