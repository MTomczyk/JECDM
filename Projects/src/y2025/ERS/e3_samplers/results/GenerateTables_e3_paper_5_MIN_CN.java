...
public class GenerateTables_e3_paper_5_MIN_CN
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            path = FileUtils.getPathRelatedToClass(GenerateTables_e3_paper_5_MIN_CN.class, "Projects", "src", File.separatorChar);
