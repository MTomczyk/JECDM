...
public class GenerateTables_e3_paper_6_STD_CN
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            path = FileUtils.getPathRelatedToClass(GenerateTables_e3_paper_6_STD_CN.class, "Projects", "src", File.separatorChar);
