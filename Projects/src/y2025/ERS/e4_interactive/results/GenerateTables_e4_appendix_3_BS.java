...
public class GenerateTables_e4_appendix_3_BS
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            path = FileUtils.getPathRelatedToClass(GenerateTables_e4_appendix_3_BS.class, "Projects", "src", File.separatorChar);
