...
public class GenerateTables_e4_appendix_4_AS
{
    /**
     * Runs the script.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            path = FileUtils.getPathRelatedToClass(GenerateTables_e4_appendix_4_AS.class, "Projects", "src", File.separatorChar);
