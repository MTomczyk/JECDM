...
/**
 * Source code for the quick-start 1 tutorial. It showcases how to instantiate and run the NSGA-II algorithm to solve a
...
public class QuickStart1
{
    ...
    public static void main(String[] args)
    {
        ...
        // Now, instantiate the NSGA-II method, using the factory-like static method (it is recommended to examine other
        // similar static methods in this class):
        NSGAII nsgaii = NSGAII.getNSGAII(
                true, // This flag indicates that NSGA-II will be parameterized to dynamically update
                ...
                // primarily to properly normalize objectives when calculating crowding distances
                ...
                // using other static methods of the NSGAII class)
        );
        ...
        {
            nsgaii.init();
            for (int g = 1; g < 300; g++) nsgaii.step(new EATimestamp(g));
        } catch (EAException e)
        {
        ...
        // can handle multiple EAs as well as coupling the simulation with visualization.
        ...
        double hv = indicator.evaluate(nsgaii); // calculate the hypervolume based on the current state of the algorithm
        ...
        dataSets.add(
                DSFactory2D.getDS(
                        ...
                        new EASource(nsgaii).createData(), // we need to provide objective vectors defined as double[][]
        ...
        ImageSaver.saveImage(
                ...
                "D:" + File.separatorChar + "quickstart1", // file path (excludes the extension; alter it according
