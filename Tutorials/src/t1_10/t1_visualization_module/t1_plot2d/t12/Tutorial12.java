package t1_10.t1_visualization_module.t1_plot2d.t12;
...
/**
 * This tutorial discusses disabling drawing area clipping.
 *
 * @author MTomczyk
 */
...
public class Tutorial12
{
    ...
    public static void main(String[] args)
    {
        ...
        // Can be turned off to allow rendering outside the drawing area
        ...
        // deviation of 0.3) and a distance from the drawn coordinates to the [0,0] coordinate.
        int noSamples = 100000;
        IRandom R = new MersenneTwister64(0);
        double[][] data = new double[noSamples][3];
        for (int i = 0; i < noSamples; i++)
        {
            double x = R.nextGaussian() * 0.3d;
            double y = R.nextGaussian() * 0.3d;
