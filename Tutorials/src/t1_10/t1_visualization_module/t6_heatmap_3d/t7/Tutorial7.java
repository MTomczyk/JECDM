...
public class Tutorial7
{
    ...
    public static void main(String[] args)
    {
        ...
        // Bucket style configurations.
        // Case 1: Default; buckets are rendered as rectangular cuboids; edges are not drawn
        pP._bucketStyle = BucketStyle.getDefault();
        // Case 2: Buckets are rendered using GL_POINTS mode.
        //pP._bucketStyle = BucketStyle.getGlPointsStyle(1.0f);
        // Case 3: Buckets are not filled; only edges are drawn (red-blue gradient; color is determined based on X-axis value);
        //pP._bucketStyle = BucketStyle.getOnlyEdgesStyle(new LineStyle(0.1f, Gradient.getViridisGradient(), 0));
        // Case 4: Buckets are not filled; only edges are drawn (red-blue gradient; color is determined based on bucket value);
        //pP._bucketStyle = BucketStyle.getOnlyEdgesStyle(new LineStyle(0.1f, Gradient.getViridisGradient(), 3));
        // Case 5: Buckets are filled; edges are drawn (black color);
