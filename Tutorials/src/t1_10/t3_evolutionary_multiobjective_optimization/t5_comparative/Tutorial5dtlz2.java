...
public class Tutorial5dtlz2
{
    ...
    public static void main(String[] args)
    {
        ...
        for (Integer m : M) populationSizes.put(m, goals.get("NSGA-III").get(m).length);
        ...
        DTLZBundle[][] problems = new DTLZBundle[M.length][algorithms.length];
        ...
        for (int i = 0; i < M.length; i++)
        {
            for (int j = 0; j < algorithms.length; j++)
            {
                ...
                problems[i][j] = DTLZBundle.getBundle(problemID, M[i], l);
            }
        }
        ...
        for (int m : M)
        {
            ...
            int l = DTLZBundle.getRecommendedNODistanceRelatedParameters(problemID, m);
            DTLZBundle referenceBundle = DTLZBundle.getBundle(problemID, m, l);
        ...
        mToDR_HV.put(2, new Range(0.0d, 0.5d));
        mToDR_HV.put(3, new Range(0.0d, 0.75d));
        mToDR_HV.put(4, new Range(0.0d, 1.25d));
        mToDR_HV.put(5, new Range(0.0d, 1.5d));

        // Maps M -> display range for the Y-axis of the convergence plot (IGD):
        HashMap<Integer, Range> mToDR_IGD = new HashMap<>();
        mToDR_IGD.put(2, new Range(0.0d, 0.125d));
        mToDR_IGD.put(3, new Range(0.0d, 0.25d));
        mToDR_IGD.put(4, new Range(0.0d, 0.5d));
        mToDR_IGD.put(5, new Range(0.0d, 1.0d));

        // Maps M -> display range for the Y-axis of the convergence plot (GD):
        HashMap<Integer, Range> mToDR_GD = new HashMap<>();
        mToDR_GD.put(2, new Range(0.0d, 0.25d));
        mToDR_GD.put(3, new Range(0.0d, 0.5d));
        mToDR_GD.put(4, new Range(0.0d, 1.0d));
        mToDR_GD.put(5, new Range(0.0d, 2.0d));
        ...
        GridPlots gridPlots = new GridPlots(plots, M.length, indicatorsNames.length, 1);
