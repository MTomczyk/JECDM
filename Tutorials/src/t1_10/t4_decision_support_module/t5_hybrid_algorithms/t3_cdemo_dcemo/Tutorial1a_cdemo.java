...
/**
 * This tutorial showcases the CDEMO algorithm ({@link emo.interactive.ktscone.cdemo.CDEMO}).
 *
 * @author MTomczyk
 */
public class Tutorial1a_cdemo
{
    /**
     * Runs the tutorial.
     *
    ...
    public static void main(String[] args)
    {
        ...
        pDU._processorToPlots[0] = new ProcessorToPlots(0, DataSet.getFor2D("CDEMO",
