...
/**
 * This tutorial showcases the DCEMO algorithm ({@link emo.interactive.ktscone.dcemo.DCEMO}).
 *
 * @author MTomczyk
 */
public class Tutorial1a_dcemo
{
    /**
     * Runs the tutorial.
     *
    ...
    public static void main(String[] args)
    {
        ...
        DCEMO dcemo = DCEMO.getDCEMO(0, populationSize,
        ...
        pDU._dataSources[0] = new EASource(dcemo, true);
        ...
        pDU._processorToPlots[0] = new ProcessorToPlots(0, DataSet.getFor2D("DCEMO",
        ...
        Runner.Params pR = new Runner.Params(dcemo);
        ...
        // Print history:
        DecisionSupportSystem decisionSupportSystem = dcemo.getDecisionSupportSystem();
