...
public class Tutorial4a
{
    ...
    public static void main(String[] args)
    {
        ...
        IGoal[] iemodGoals = GoalsFactory.getLNormsDND(M, 50, Double.POSITIVE_INFINITY, problem._normalizations);
        IGoal[] moeadGoals = GoalsFactory.getLNormsDND(M, 50, Double.POSITIVE_INFINITY, problem._normalizations);
        ...
        IPreferenceModel<LNorm> dmModel = new model.definitions.LNorm(new LNorm(new double[]{0.6d, 0.4d},
