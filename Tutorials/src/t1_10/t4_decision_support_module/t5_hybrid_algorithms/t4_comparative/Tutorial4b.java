...
public class Tutorial4b
{
    ...
    public static void main(String[] args)
    {
        ...
        IGoal[] iemodGoals = GoalsFactory.getLNormsDND(M, 15, Double.POSITIVE_INFINITY, problem._normalizations);
        IGoal[] moeadGoals = GoalsFactory.getLNormsDND(M, 15, Double.POSITIVE_INFINITY, problem._normalizations);
        ...
        IPreferenceModel<LNorm> dmModel = new model.definitions.LNorm(new LNorm(new double[]{0.6d, 0.2d, 0.2d}, Double.POSITIVE_INFINITY, problem._normalizations));
        ...
        // NEMO0
        {
            ...
            pFRS._samplingLimit = populationSize;
