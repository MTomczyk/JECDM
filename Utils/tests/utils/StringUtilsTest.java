    ...
    {
        {
            ...
            assertEquals(delta, "[days = 1, hours = 0, minutes = 0, seconds = 0, millis = 0]");
        }
        {
            LocalDateTime ldt1 = LocalDateTime.of(0, 1, 1, 0, 0, 0);
            ...
            String delta = StringUtils.getDeltaTime(ldt1, ldt2);
            System.out.println(delta);
            assertEquals(delta, "[days = 1, hours = 0, minutes = 0, seconds = 1, millis = 0]");
        }
        {
            LocalDateTime ldt1 = LocalDateTime.of(0, 1, 1, 0, 0, 0);
            ...
            String delta = StringUtils.getDeltaTime(ldt1, ldt2);
            System.out.println(delta);
            assertEquals(delta, "[days = 2, hours = 5, minutes = 6, seconds = 1, millis = 0]");
        }
    }
}