 ...
 * @author MTomczyk
 */
class ValueFilterUnnormalizedUpdater2D extends QueuedSwingWorker<Void, Void>
{
    /**
     * Heatmap layer model.
     */
     ...
     * It is the construct's responsibility to determine the corresponding bounds in the original data space.
     ...
     */
    public ValueFilterUnnormalizedUpdater2D(HeatmapLayerModel layerModel,
    ...
    protected Void doInBackground()
    {
        ...
        if (_layerModel.isInSortedMode()) _layerModel.determineTheIndicesInterval();
        notifyTermination();
        return null;
    }
