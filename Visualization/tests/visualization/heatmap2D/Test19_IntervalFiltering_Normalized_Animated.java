 ...
 * @author MTomczyk
 */
public class Test19_IntervalFiltering_Normalized_Animated
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        {
            double p = (double) i / 999.0d;
            double v = sp + Math.sin(5 * 2.0d * Math.PI * p) * sp;
            try
            {
                Thread.sleep(2);
            ...
            plot.getModel().setValueFilterInTheNormalizedSpace(v, 1.0d - v);
        }
