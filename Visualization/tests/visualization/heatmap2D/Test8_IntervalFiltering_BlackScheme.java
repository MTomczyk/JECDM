 ...
 * @author MTomczyk
 */
public class Test8_IntervalFiltering_BlackScheme
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        //pP._scheme._size.put(SizeFields.MARGIN_LEFT_RELATIVE_SIZE_MULTIPLIER, 0.25f);
        //pP._scheme._align.put(AlignFields.COLORBAR, Align.LEFT);
        // pP._scheme._size.put(SizeFields.MARGIN_BOTTOM_RELATIVE_SIZE_MULTIPLIER, 0.25f);
        // pP._scheme._align.put(AlignFields.COLORBAR, Align.BOTTOM);
        //pP._scheme._size.put(SizeFields.MARGIN_TOP_RELATIVE_SIZE_MULTIPLIER, 0.25f);
        //pP._scheme._align.put(AlignFields.COLORBAR, Align.TOP);
