 ...
 * @author MTomczyk
 */
public class Test2_6_plots_black
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        // plot 5
        {
            plots[4] = new DummyColorPlot(Color.DARK);
        }
        // plot 6
        {
        ...
        GridPlots.Params pW = new GridPlots.Params(plots, 2, 3);
        pW._noUpdatersQueues = 4;
        AbstractPlotsWrapper wrapper = new GridPlots(pW);
        Frame.Params pF = Frame.Params.getParams(wrapper, 0.6f);
        pF._debugMode = (args != null) && (args.length > 0) && (args[0].equals("T"));
        pF._title = "6 plots";
        pF._backgroundColor = Color.DARK;
