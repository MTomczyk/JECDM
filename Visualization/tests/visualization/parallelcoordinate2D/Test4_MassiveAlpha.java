 ...
 * @author MTomczyk
 */
public class Test4_MassiveAlpha
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        pP._pDisplayRangesManager = DisplayRangesManager.Params.getForParallelCoordinatePlot2D(dims);
        ...
        Gradient gradient = Gradient.getGradientFromColorMatrix(Viridis.colors_alpha_increasing, "V", 32, false);
        LineStyle ls = new LineStyle(0.25f, gradient, 0);
