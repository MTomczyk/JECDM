...
public class Test10_DS_Swap
{
    ...
    public static void main(String[] args)
    {
        ...
        IDataSet ds1 = DataSet.getFor2D("DS 1", new MarkerStyle(5, Color.RED, Marker.SQUARE));
        // marker: fill = red, edge = black; no line
        IDataSet ds2 = DataSet.getFor2D("DS 2j", new MarkerStyle(5, Color.RED, Marker.SQUARE, new LineStyle(1.0f, Color.GREEN)));
        // marker: fill = viridis, edge = none; no line
        IDataSet ds3 = DataSet.getFor2D("DS 3", new MarkerStyle(5, Gradient.getViridisGradient(), 0, Marker.SQUARE));
        // marker: fill = none, edge = green; no line
        IDataSet ds4 = DataSet.getFor2D("DS 4", new MarkerStyle(5, null, Marker.SQUARE, new LineStyle(1.0f, Color.GREEN)));
        // marker: fill = red, edge = viridis; no line
        IDataSet ds5 = DataSet.getFor2D("DS 5", new MarkerStyle(5, Color.RED, Marker.SQUARE, new LineStyle(1.0f, Gradient.getViridisGradient(), 0)));
        // marker: fill = red, edge = viridis; black line
        IDataSet ds6 = DataSet.getFor2D("DS 6", new MarkerStyle(5, Color.RED, Marker.SQUARE, new LineStyle(1.0f, Gradient.getViridisGradient(), 0)), new LineStyle(2.0f, Color.BLACK));
        ...
        dss2.add(DataSet.getFor2D("DS 1   aaaaaaaaaa", (double[][]) null, new MarkerStyle(5, Color.BLUE, Marker.SQUARE)));
        ...
        plot.getModel().setDataSets(dss2, true, true);
