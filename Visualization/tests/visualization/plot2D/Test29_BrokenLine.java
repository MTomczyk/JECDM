 ...
 * @author MTomczyk
 */
public class Test29_BrokenLine
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        double [][] d1 = new double[][] {{-1.0d, -1.0d}, {0.0d, -1.0d}, {1.0d, -1.0d}};
        double [][] d2 = new double[][] { {1.0d, 0.0d}, {0.0d, 0.0d}, {-1.0d, 0.0d}};
        LinkedList<double[][]> d = new LinkedList<>();
        d.add(d1);
        d.add(null);
        d.add(d2);

        dss2.add(DataSet.getFor2D("DS 2j",d, new MarkerStyle(5, Color.RED, Marker.SQUARE,
                new LineStyle(1.0f, Color.GREEN)), new LineStyle(1.0f, Color.BLUE)));
