 ...
 * @author MTomczyk
 */
public class Test34_Disable_DSs
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.SQUARE, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("SQUARE", new double[][]{{0.75d, 0.0d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.CIRCLE, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("CIRCLE", new double[][]{{0.75d, 0.25d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.TRIANGLE_UP, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("T-UP", new double[][]{{0.75d, 0.5d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.TRIANGLE_DOWN, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("T-DOWN", new double[][]{{0.75d, 0.75d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.TRIANGLE_LEFT, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("T-LEFT", new double[][]{{0.75d, 1.0d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.TRIANGLE_RIGHT, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("T-RIGHT", new double[][]{{0.75d, 1.25d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.PENTAGON, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("PENTAGON", new double[][]{{0.75d, 1.5d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.STAR, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("STAR", new double[][]{{0.75d, 1.75d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.HEXAGON_HOR, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("H-HOR", new double[][]{{0.75d, 2.0d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.HEXAGON_VERT, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("H-VERT", new double[][]{{0.75d, 2.25d}}, ms));
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.DIAMOND_HOR, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
            dss.add(DataSet.getFor2D("D-HOR", new double[][]{{0.75d, 2.5d}}, ms));
            dss.get(dss.size()-1).setDisplayableOnLegend(true);
            dss.get(dss.size()-1).setSkipRendering(true);
        }
        {
            MarkerStyle ms = new MarkerStyle(s, Gradient.getViridisGradient(), 1, Marker.DIAMOND_VERT, new LineStyle(r, Gradient.getPlasmaGradient(), 1));
