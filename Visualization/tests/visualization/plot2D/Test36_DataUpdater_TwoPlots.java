 ...
 * @author MTomczyk
 */
public class Test36_DataUpdater_TwoPlots
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        GridPlots GP = new GridPlots(new AbstractPlot[]{plotA, plotB}, 1, 2);
        ...
        try
        {
            DU = DataUpdater.getDataUpdaterLinkedWithMultiplePlots(frame.getModel().getPlotsWrapper(), source,
                    new IDataSet[]{reference1, reference2});
        } catch (Exception e)
        {
