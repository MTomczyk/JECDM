 ...
 * @author MTomczyk
 */
public class Test14_Animation_Dynamic_Save
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        pP._pDisplayRangesManager._DR[0] = new DisplayRangesManager.DisplayRange(null, true, true);
        pP._pDisplayRangesManager._DR[1] = new DisplayRangesManager.DisplayRange(null, true, true);
