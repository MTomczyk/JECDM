 ...
 * @author MTomczyk
 */
public class Test23_PolyQuadLine_Random
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        int P = 100;
        {
            ...
            DataSet ds = DataSet.getFor3D("test1",d, null, new LineStyle(0.01f, Color.RED, Line.POLY_QUAD));
        ...
        }
        {
            ...
            DataSet ds = DataSet.getFor3D("test2", d, null, new LineStyle(0.01f, Gradient.getViridisGradient(), 0, Line.POLY_QUAD));
            dss.add(ds);
        }
