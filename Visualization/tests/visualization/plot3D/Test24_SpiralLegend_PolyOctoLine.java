 ...
 * @author MTomczyk
 */
public class Test24_SpiralLegend_PolyOctoLine
{
    /**
    ...
    public static void main(String[] args)
    {
...

        {
            ...
            DataSet ds = DataSet.getFor3D("test", DS, null, new LineStyle(0.05f, Gradient.getViridisGradient(), 0, Line.POLY_OCTO));
            dss.add(ds);
        }
